...
import { CartItem, Order, ShippingAddress, PaymentResult } from '@/types';
...
export const createOrder = async () => {
  try {
    ...
    if (!user.address) {
      return { success: false, message: 'No shipping address' };
    }
...
// now we need to work on a page to show the order details
